...
flags.DEFINE_string("ner_model_config", "small","A type of model. Possible options are: small, medium, large.")
flags.DEFINE_string("ner_data_path", data_path, "data_path")
flags.DEFINE_string("ner_train_dir", train_dir, "Training directory.")
flags.DEFINE_bool("ner_use_fp16", False, "Train using 16-bit floats instead of 32bit floats")
